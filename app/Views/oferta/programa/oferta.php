   <!-- page title start -->
   <div class="page-title-area bg-overlay" style="background-image: url('<?= base_url('edumen/assets/img/bg/3.png') ?>')">
       <div class="container">
           <div class="row">
               <div class="col-xl-7 col-lg-8">
                   <div class="breadcrumb-inner">
                       <h2 class="page-title">Have a look latest Course here around you</h2>
                       <ul class="page-list">
