    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div class="d-flex align-items-center me-3">
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Panel Principal
                ...
                <div class="col-xxl-4">
                    <div class="card card-xxl-stretch">
                        <div class="card-header border-0 bg-danger py-5">
                            <h3 class="card-title fw-bolder text-white">Inscripciones</h3>
                                    ...
                                    <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7 ">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <a href="#" class="text-primary fw-bold fs-6 d-block">Nuevos Usuarios</a>
                                            </div>
                                            <div class="col text-primary fw-bold text-end px-10 fs-2hx"><?= $cantidadPersonas ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
