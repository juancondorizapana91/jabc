...
var KTModalOfferADealDetails = function () {
	...
	return {
		...
		init: function () {
			form = KTModalOfferADeal.getForm();
			stepper = KTModalOfferADeal.getStepperObj();
			nextButton = document.querySelector('[data-kt-element="details-next"]');
			previousButton = document.querySelector('[data-kt-element="details-previous"]');
...
var KTModalOfferADealFinance = function () {
	...
	return {
		...
		init: function () {
			form = KTModalOfferADeal.getForm();
			stepper = KTModalOfferADeal.getStepperObj();
			nextButton = document.querySelector('[data-kt-element="finance-next"]');
			previousButton = document.querySelector('[data-kt-element="finance-previous"]');
