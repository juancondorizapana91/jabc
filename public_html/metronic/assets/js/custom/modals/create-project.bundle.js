...
var KTModalCreateProjectBudget = function () {
	...
	return {
		...
		init: function () {
			...
			nextButton = document.querySelector('[data-kt-element="budget-next"]');
			previousButton = document.querySelector('[data-kt-element="budget-previous"]');
...
var KTModalCreateProjectTargets = function () {
	...
	return {
		...
		init: function () {
			form = KTModalCreateProject.getForm();
			stepper = KTModalCreateProject.getStepperObj();
			nextButton = document.querySelector('[data-kt-element="targets-next"]');
			previousButton = document.querySelector('[data-kt-element="targets-previous"]');
