            ...
            .each(function () {
              ...
              if (elemento.id != " ") {
                ...
                if (fila === "id_profesiones_ocupaciones") {
                  ...
                  console.log(prof);
                  $("#content-data").append(etiquetaValor(elemento.id, prof));
                } else {
                  $("#content-data").append(
  ...
  $("#ci").on("change", function (e) {
    ...
    $.ajax({
      ...
      $("#id_universidades_normales")
        ...
        .trigger("change");
      $("#tipo_universidad")
        .val(response[0].tipo_universidad)
        .trigger("change");
      $("#gestion_titulacion")
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        $.ajax({
          ...
          console.log(response.id_pago_programa);
          if (typeof response.exito != "undefined") {
            Swal.fire("Exito!", response.exito, "success");
            limpiar();
            window.open(
              "/inscripcion/generarFactura?id=" + response.id_pago_programa,
              "_blank"
            );
            // location.reload();
          }
